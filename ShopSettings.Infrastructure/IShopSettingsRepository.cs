...
public interface IShopSettingsRepository
{
    ...
    Task<(Alchemist.Product.Data.ShopSettings, IEnumerable<Alchemist.Product.Data.ShopSettings>)> SaveShopSettingsWithChildren(Alchemist.Product.Data.ShopSettings parentShopSettings, 
