...
public class ShopCategoryControllerTests
{
    ...
    public ShopCategoryControllerTests()
    {
        ...
        _mediator.Setup(m => m.Send(It.IsAny<CreateCommand<ShopCategory>>(), It.IsAny<CancellationToken>()))
                 .Returns((CreateCommand<ShopCategory> req, CancellationToken ct) => _categoryRepository.Object.Create(req.Entity, ct));
        ...
        _controller = new ShopCategoryController(_logger, _mediator.Object, _messageSender.Object)
        {
