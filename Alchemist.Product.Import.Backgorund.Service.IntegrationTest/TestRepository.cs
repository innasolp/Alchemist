...
public static class TestRepository
{
    ...
    public static List<IShopSettings> GetShopSettingsImportTestData(IEnumerable<IShop> shops)
    {
        ...
        foreach (var shop in shops)
        {
            ...
            var productShopImportSettings = new ProductShopImportSettings() { ProductUrlFormat = $"https://url{Guid.NewGuid()}" };
            ...
            var categoryShopImportSettings = new CategoryShopImportSettings() { CategorySourceUrl = $"https://url{Guid.NewGuid()}" };
