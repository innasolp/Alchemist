...
public class ImportsettingsWebAppFullFactory(bool isApi, string? shopApiHost, int httpPort, int httpsPort,
    string settingsApiDbConnectionString, int settingsApiHttpPort, int settingsApiHttpsPort,
   TestServer signalRTestServer
        ) : ImportSettingsWebAppFactory(isApi, shopApiHost, httpPort, httpsPort,
        SettingsApiHelper.CreateSettingsApiHttpClient(settingsApiDbConnectionString, settingsApiHttpPort, settingsApiHttpsPort, signalRTestServer))
{ 
