...
{       
    ...
    {
        var product = TestHelper.GetItemFromJson<Products.Json.Product>("Content/ozon.product.full.json", "Content/ozon.product.settings.json");
    ...
    {
        var product = TestHelper.GetItemFromJson<Products.Json.Product>("Content/ozon.product.short.json", "Content/ozon.product.settings.json");
