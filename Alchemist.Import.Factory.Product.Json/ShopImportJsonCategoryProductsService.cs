...
public class ShopImportJsonCategoryProductsService(ILogger<ShopImportJsonCategoryProductsService> logger, 
    ...
    : ShopImportJsonCategoryProductsService<CategoryProducts, Import.Products.Json.Product>(logger, loader, url, serviceName, shopCategories, itemHandler, productUrlFormat, categoryUrlFormat, sourceName, productJsonSettings, categoryJsonSettings, pageProductCount, productLoadData, categoryLoadData, productUrlFormatType, categoryUrlFormatType)
{
}