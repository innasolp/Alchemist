...
internal class ShopImportHttpJsonCategoryProductsStatefulService(ILogger<ShopImportHttpJsonCategoryProductsStatefulService> logger,
    ...
    : ShopImportCategoryProductsStatefulService<CategoryProducts, Product>(logger, loader, url, shopCategories, itemHandler, productUrlFormat, categoryUrlFormat, sourceName, 
